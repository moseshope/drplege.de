        ...
        <div class="login-content mt-5">
          ...
          <form class="px-2" method="post" id="forgot-password">
            <div class="form-group p-2 mt-2">
              ...
              <input type="text" name="email" value="<?php echo $emailValue?>" class="form-control custom-input"
                id="email" placeholder="E-Mail eingeben">
              <p class="error m-0" id="forgot-email-error"></p>
            </div>
            <div class="d-flex justify-content-end mx-3">
              <p class="mb-0  cursor-pointer" onclick="window.location = './login'">Zurück zum Login</p>
            </div>
            <div class="d-flex justify-content-center align-items-center py-2 my-3">
              <button type="submit" class="success-button cursor-pointer p-1"
                style="font-size: var(--sm-text) !important;">Passwort vergessen</button>
            </div>
          </form>
        </div>
