        ...
        <div class="col-12 col-lg-6">
          <div class="select-time">
            ...
            <ul class="row" id="selectTime">
              ...
              <label class="col-12">
                <input type="checkbox" class="optionalFeature" name="staff_services[]" value="<?= $service['id'] ?>"
                  <?php if (in_array($service['id'], $checkedService)) echo 'checked'; ?>>
                <?= $service['services'] ?>
              </label>
              <?php } ?>
            </ul>
            ...
            <div class="d-flex justify-content-center align-items-center mt-5 mb-3">
              <button type="button" class="success-button cursor-pointer mx-3" data-bs-target="" data-bs-toggle="modal"
                data-bs-dismiss="modal" id="refresh">Aktualisieren</button>
