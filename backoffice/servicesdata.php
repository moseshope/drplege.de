...
<div id="main-content">
  <div class="p-2 w-100">
    ...
    <div class="d-flex flex-wrap">
      ...
      <button type="submit" class="cursor-pointer custom-secondary-button mt-2 mt-sm-0 m-2" data-bs-toggle="modal"
        data-bs-target="#add-services"><i class="bi bi-plus"
              ...
              <tr class="doctor-row border-bottom">
                ...
                <td>
                  <div class="d-flex justify-content-center" style="min-width: 350px;">
                    <!-- Edit Button -->
                    <div class="editservices" id="editservices-<?php echo $i ?>"
                      data-id="<?php echo $servicesList[$i]['id']; ?>" data-bs-toggle="modal"
                      data-bs-target="#edit-services">
                      <i class="fas fa-edit cursor-pointer p-2"></i>
                    </div>

                    <!-- Delete Button -->
                    <div class="deleteservices text-danger" id="deleteservices-<?php echo $i ?>"
                      data-id="<?php echo $servicesList[$i]['id']; ?>">
    ...
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
      <div class="modal-content p-3 custom-modal" style="border-radius: 16px;">
        ...
        <div class="d-flex justify-content-center align-items-center py-2 my-3">
          <button type="button" id="cancelSericesBtn" class="cancel-button cursor-pointer mx-1" data-bs-dismiss="modal"
  ...
  <div class="modal fade" id="Confirmation" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content p-3 custom-modal" style="border-radius: 16px;">
        ...
        <div class="d-flex justify-content-center align-items-center">
          <button type="button" id="ConfirmationNoBtn" class="cancel-button cursor-pointer mx-1" data-bs-dismiss="modal"
            style="margin-right: 3px;">Nein</button>
          <button type="button" id="ConfirmationYesBtn" class="success-button cursor-pointer mx-1"
  ...
  <div class="modal fade " id="ShowInfo" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    ...
    <div class="modal-dialog modal-dialog-centered " role="document">
      <div class="modal-content p-3 custom-modal" style="border-radius: 16px;">
        ...
        <div class="d-flex justify-content-center align-items-center">
          <button id="ServicesShowInfoBtn" name="ServicesShowInfoBtn" type="button"
            class="success-button cursor-pointer" data-bs-dismiss="modal">Okay</button>
        </div>
      </div>
    </div>
  </div>
...
<form id="EditServices" method="post" action="">
  <div class="modal fade " id="edit-services" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    ...
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
      <div class="modal-content p-3 custom-modal" style="border-radius: 16px;">
        ...
        <div class="d-flex justify-content-center align-items-center py-2 my-3">
          <button type="button" id="cancelEdit" class="cancel-button cursor-pointer mx-1" data-bs-dismiss="modal"
            style="margin-right: 5px;">Abbrechen</button>
  ...
  <!-- staff Confirmation -->
  <div class="modal fade " id="EditSlotConfirmation" tabindex="-1" role="dialog"
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content p-3 custom-modal" style="border-radius: 16px;">
      ...
      <div class="d-flex justify-content-center align-items-center">
        ...
        <button type="button" class="cancel-button cursor-pointer mx-1" data-bs-dismiss="modal"
          style="margin-right: 3px;">Nein</button>
        <button type="button" id="deleteConfirmationYesBtn" name="deleteConfirmationYesBtn"
          class="mx-1 success-button cursor-pointer" style="margin-left: 3px;">Ja</button>
...
<div class="modal fade" id="deleteSlotShowInfo" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
  ...
  <div class="modal-dialog modal-dialog-centered " role="document">
    <div class="modal-content p-3 custom-modal" style="border-radius: 16px;">
      ...
      <div class="d-flex justify-content-center align-items-center">
        <button id="ServicesShow" type="submit" class="success-button cursor-pointer"
          data-bs-dismiss="modal">Okay</button>
      </div>
    </div>
  </div>
