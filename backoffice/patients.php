...
if ($role == 2) {
  ...
  $conditions = array();
  if ($searchTerm !== null) {
    $conditions[] = "(patients.name LIKE '%$searchTerm%' OR patients.email LIKE '%$searchTerm%' OR user.name LIKE '%$searchTerm%' OR services.services LIKE '%$searchTerm%' OR patients.id LIKE '%$searchTerm%' OR patients.selected_date LIKE '%$searchTerm%')";
    }
    ...
    <div class="px-2">
      ...
      <div class="d-flex justify-content-between flex-wrap">
        ...
        <div class="d-flex flex-wrap align-items-center m-2">
          ...
          <div>
            <button type="submit" class="cursor-pointer showTimeBtn custom-main-btn mt-2 mt-md-0 mx-3"
          ...
          <div>
            <button type="submit" class="cursor-pointer showTimeBtn custom-main-btn mt-2 mt-md-0"
              style="background-color: var(--main); color: white; border-radius: 16px;"
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content p-3 custom-modal" style="border-radius: 16px;">
      ...
      <div class="d-flex justify-content-center align-items-center">
        ...
        <button type="submit" class="success-button cursor-pointer" data-bs-toggle="modal" data-bs-dismiss="modal"
          id="conformationYesBtn" style="margin-left: 3px;">Ja</button>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="modal-content p-3 custom-modal" style="border-radius: 16px;">
      ...
      <div class="d-flex justify-content-center align-items-center">
        <button type="button" class="cancel-button cursor-pointer" data-bs-dismiss="modal"
          style="margin-right: 3px;">Nein</button>
        <button type="submit" class="success-button cursor-pointer" data-bs-toggle="modal" data-bs-dismiss="modal"
          id="cancelConformationYesBtn" style="margin-left: 3px;">Ja</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade " id="cancel-show-info" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
  ...
  <div class="modal-dialog modal-dialog-centered " role="document">
    <div class="modal-content p-3 custom-modal" style="border-radius: 16px;">
      ...
      <div class="d-flex justify-content-center align-items-center">
        <button type="submit" class="success-button cursor-pointer" data-bs-dismiss="modal"
          id="cancelShowInfoBtn">Okay</button>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="modal-content p-3 custom-modal" style="border-radius: 16px;">
      ...
      <div class="d-flex justify-content-center align-items-center">
        <button type="button" class="cancel-button cursor-pointer" data-bs-dismiss="modal"
          style="margin-right: 3px;">Nein</button>
        <button type="submit" class="success-button cursor-pointer" data-bs-toggle="modal" data-bs-dismiss="modal"
          id="deleteConformationYesBtn" style="margin-left: 3px;">Ja</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade " id="delete-show-info" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
  ...
  <div class="modal-dialog modal-dialog-centered " role="document">
    <div class="modal-content p-3 custom-modal" style="border-radius: 16px;">
      ...
      <div class="d-flex justify-content-center align-items-center">
        <button type="submit" class="success-button cursor-pointer" data-bs-dismiss="modal"
          id="deleteShowInfoBtn">Okay</button>
      </div>
    </div>
  </div>
</div>
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content p-3 custom-modal" style="border-radius: 16px;">
        ...
        <div class="d-flex justify-content-between flex-wrap py-1">
          <p><span style="font-weight: 800;">E-Mail: </span><a href="patientsEmail"><span id="patientsEmail"></span></a>
          </p>
          <p><span style="font-weight: 800;">Telefon: </span> <a href="patientsTelephone"><span
        ...
        <div class="form-group p-2 my-2">
          ...
          <textarea class="form-control custom-input" name="recipe" id="recipe" placeholder="Write here"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content p-3 custom-modal" style="border-radius: 16px;">
        ...
        <div class="d-flex justify-content-center align-items-center">
          <button type="button" class="cancel-button cursor-pointer" data-bs-dismiss="modal"
            style="margin-right: 3px;">Nein</button>
          <button type="button" class="success-button cursor-pointer" data-bs-target="" data-bs-toggle="modal"
            data-bs-dismiss="modal" id="editconformationYesBtn" style="margin-left: 3px;">Ja</button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="modal fade " id="edit-patients" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content p-3 custom-modal" style="border-radius: 16px;">
        ...
        <p class="py-2" style="font-weight: 800;font-size: var(--md-text);">Patiernen: <span id="E-PatientsName"></span>
        </p>
        <div class="d-flex justify-content-between flex-wrap py-1">
          <p><span style="font-weight: 800;">E-Mail: </span> <a href="mailto:patientsEmail"><span
                id="E-patientsEmail"></span></a> </p>
          <p><span style="font-weight: 800;">Telephone: </span><a href="tel:patientsTelephone"><span
                id="E-patientsTelephone"></span></a> </p>
        </div>
        ...
        <div class="col-lg-12 col-12">
          <div class="form-group p-2 my-2">
            ...
            <input type="date" name="date" class="form-control custom-input" id="E-datepicker"
      ...
      <div class="modal-content p-3 custom-modal" style="border-radius: 16px;">
        ...
        <div class="d-flex justify-content-center align-items-center">
          ...
          <button type="button" class="success-button cursor-pointer" data-bs-toggle="modal" data-bs-dismiss="modal"
            id="deleteConformation" style="margin-left: 3px;">Ja</button>
        </div>
      </div>
    </div>
  </div>
