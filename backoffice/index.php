...
?>
                                            ...
                                            <td>
                                                ...
                                                <div class="d-flex justify-content-center dropdown">
                                                    <span onclick="HandleDropMenu('Drop-menu-<?php echo $i + 1; ?>')"
                                                        ...
                                                        class="px-1 cursor-pointer" data-bs-toggle="dropdown"
                                                        aria-expanded="false">
                                                    ...
                                                    <ul id="Drop-menu-<?php echo $i + 1; ?>" class="dropdown-content">
                                                            ...
                                                            <li class="px-2 py-1 cursor-pointer patientsEditButton" data-id="<?php echo $PatientsList[$i]['id'];?>"  style="border-bottom: 1px solid gray;" data-bs-toggle="modal">
                                                                Rebooking
                                                            </li>
                                                            <li onclick="HandleDropMenu('Drop-menu-1')" data-bs-toggle="modal"
                                                                data-bs-target="#Confirmation" class="px-2 py-1 cursor-pointer"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-12">
                                <div class="form-group p-2 my-2">
                                    ...
                                    <input type="file" name="profile" class="form-control custom-input d-none" id="profile-image" aria-invalid="false" accept="image/*">
                                    <button class="custom-main-btn d-block w-100" type="button" id="open-image-picker"><i class="bi bi-upload mx-2"></i>Bild hochladen</button>
                                    <span class="error" id="status-error"></span>
                                </div>
        ...
        <div class="modal fade " id="show-info" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
            ...
            <div class="modal-dialog modal-dialog-centered " role="document">
                <div class="modal-content p-3 custom-modal" style="border-radius: 32px;">
                    ...
                    <div class="d-flex justify-content-center align-items-center">
                        <button id="ShowInfoBtn" type="submit" class="success-button cursor-pointer" data-bs-dismiss="modal">Okay</button>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content p-3 custom-modal" style="border-radius: 32px;">
                    ...
                    <div class="d-flex justify-content-between flex-wrap py-1">
                        <p><span style="font-weight: 800;">E-Mail: </span> <a href="mailto:patientsEmail"><span id="patientsEmail"></span></a> </p>
                        <p><span style="font-weight: 800;">Telefon: </span> <a href="tel:patientsTelephone"><span id="patientsTelephone"></span></a> </p>
                    </div>
                    <?php if($role == 1){?>
    ...
    <div class="modal fade " id="deleteServiceConfirmation" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div class="modal fade " id="service-delete-show-info" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered " role="document">
                <div class="modal-content p-3 custom-modal" style="border-radius: 16px;">
                    <div class="d-flex justify-content-center align-items-center flex-column py-4">
                    ...
                    <div class="d-flex justify-content-center align-items-center">
                        <button type="submit" class="success-button cursor-pointer" data-bs-dismiss="modal" id="serviceOkBtn">Okay</button>
                    </div>
                </div>
            </div> 
    <!-- Bootstrap -->
    ...
    <script>
        ...
        function fetchData() {
            ...
            $.ajax({
                ...
                method: 'GET',
                data: { date: date, page: currentPage, searchQuery: searchQuery},
                ...
                const row = `<tr>
                    ...
                    <td>
                        <div class="d-flex justify-content-center dropdown">
                            ...
                            <ul id="Drop-menu-${index + 1}" class="dropdown-content">
                                <li class="px-2 py-1 mx-2 cursor-pointer patientsEditButton"
                                    data-id="${index + 1}"
                                    style="border-bottom: 1px solid #d7caca;"
                                    onclick="openRebookingModal(${patient.id})">Umbuchen</li>
                                <li class="px-2 py-1 mx-2 text-danger cursor-pointer patientsEditButton"
                                    data-id="${index + 1}"
                                    style=""
                                    onclick="cancelRebookingModal(${patient.id})">Abbrechen</li>
                            </ul>
                        </div>
                    </td>
        ...
        $('#deleteServiceYesBtn').on('click', function() {
            ...
            $.ajax({
                url: './ajax/service.php',
                method: 'POST',
                data: { deleteServiceId: serviceId },
                success: function (response) {
                        ...
                        <div class="d-flex justify-content-center dropdown">
                            ...
                            <ul id="Drop-menu-${index + 1}" class="dropdown-content">
                                <li class="px-2 py-1 mx-2 cursor-pointer patientsEditButton"
                                    data-id="${index + 1}"
                                    style="border-bottom: 1px solid #d7caca;"
                                    onclick="openRebookingModal(${patient.id})">Umbuchung</li>
                                <li class="px-2 py-1 mx-2 cursor-pointer patientsEditButton"
                                    data-id="${index + 1}"                                
                                    onclick="cancelRebookingModal(${patient.id})">Abbrechen</li>
                            </ul>
