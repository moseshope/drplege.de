  ...
  <div class="p-2 w-100">
    ...
    <div class="d-flex flex-wrap">
      ...
      <button type="submit" class="cursor-pointer custom-secondary-button mt-2 mt-sm-0 m-2" data-bs-toggle="modal"
        data-bs-target="#add-slot"><i class="bi bi-plus" style="color: white;width: 20px;height: 20px;"></i>Zeit
        hinzufügen</button>
    </div>
              ...
              <tr class="doctor-row">
                ...
                <td>
                  <div class="d-flex justify-content-center mx-auto" style="width: 100px;">
                    ...
                    <!-- Delete Button -->
                    <div class="todeletebutton text-danger cursor-pointer" data-id="<?php echo $timeList[$i]['id']; ?>"
    ...
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
      <div class="modal-content p-3 custom-modal" style="border-radius: 16px;">
        ...
        <div class="d-flex justify-content-center align-items-center py-2 my-3">
          ...
          <button type="button" id="addSlotBtn" class="success-button cursor-pointer"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content p-3 custom-modal" style="border-radius: 16px;">
        ...
        <div class="d-flex justify-content-center align-items-center">
          ...
          <button type="button" id="toConfirmationYesBtn" class="success-button cursor-pointer mx-1"
    ...
    <div class="modal-dialog modal-dialog-centered modal-md" role="document">
      <div class="modal-content p-3 custom-modal" style="border-radius: 16px;">
        ...
        <div class="d-flex justify-content-center align-items-center py-2 my-3">
          <button type="button" class="cancel-button cursor-pointer" style="margin-right: 5px;"
            data-bs-dismiss="modal">Abbrechen</button>
          <button type="button" id="updateSlotBtn" class="success-button cursor-pointer"
            style="margin-left: 5px;">Aktualisieren</button>
        </div>
      </div>
    </div>
  </div>
...
<div class="modal fade " id="deleteSlotShowInfo" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
  ...
  <div class="modal-dialog modal-dialog-centered " role="document">
    <div class="modal-content p-3 custom-modal" style="border-radius: 16px;">
      ...
      <div class="d-flex justify-content-center align-items-center">
        <button id="slotShowInfoBtn" type="submit" class="success-button cursor-pointer"
          data-bs-dismiss="modal">Okay</button>
      </div>
    </div>
  </div>
