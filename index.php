...
<body>
		...
		<div class="container" id="container">
				...
				<div class="row">
						...
						<div id="multi-step-form">
							...
							<div class="step step-3" style="display: none;">
								...
								<div class="treatment-box mt40">
									...
									<div class="common-box  mb-4 doctor-list-box text-center" id="timeList3" style=""><?= $ln['select_date'] ?></div>
								</div>	
							</div>
									...
									<div class="common-box  mb-4 doctor-list-box">
										<form class="patient-form" method="post" id="userForm">
											<div class="row">
												...
												<div class="col-md-6">
													<div class="form-field">
													<input type="text" onfocus="(this.type='date')" onblur="(this.type='text')" name="birthdate" id="birthdateInput" placeholder="<?= $ln['birth_date_input'] ?>">
													</div>
													<!-- <div class="form-field">
												...
												<div class="col-md-6">
													<div class="form-field">
													<input type="number" name="phone" id="phoneInput" placeholder="<?= $ln['telephone_input'] ?>">
												...
												<div class="col-md-12">
													<div class="form-field button-flex">
														<button type="button" id="submitButton" data-bs-toggle="modal"><?= $ln['submit_button'] ?></button>
														<button type="button" class="cancel-btn" id="cancelButton"><?= $ln['cancel_button'] ?></button>
													</div>
												</div>
											</div>
										</form>
					...
					<div class="col-lg-5 col-md-12 col-12">
						<div class="appointment-main-box">
							<div class="back-btn">
								<button type="button" class="prev-step" id="nextButton"><i class="fa-light fa-arrow-left"></i><?= $ln['next_button'] ?></button>
							</div>
						...
						<div class="Note-Box">							
							<span style="font-weight: 400;"><i class="fa-regular fa-envelope me-3"></i><a href="mailto:info@drpleger.de"><?= $ln['note_info'] ?></a> </span>
							<span style="font-weight: 400;"><i class="fa-regular fa-phone me-3 my-1"></i><a href="tel:03921 - 30 68">03921 - 30 68</a> </span>
							<span style="font-weight: 400;"><i class="fa-regular fa-fax me-3 mb-2"></i><a href="tel:03921 - 63 51 77">03921 - 63 51 77</a> </span>
							<span style="font-weight: 400;"><i class="fa-solid fa-location-dot me-3"></i><a href=""><span style="margin-left: 2px;display: inline-block;"><?= $ln['note_location1'] ?></span><br><span style="margin-left: 30px;"><?= $ln['note_location2'] ?></span> <span style="margin-left: 30px;"><?= $ln['note_location3'] ?></span></a> </span>
						</div>
					</div>
				</div>
			</div>
			<div class="mt-5">
				...
				<div class="mt-2 text-center">
					<a href="javascript:void(0);" class="lang <?= ($lang == 'de') ? 'red-text' : ''; ?>" data-lang="de"><?= $ln['lang_text'] ?></a>
					<a href="" class="mx-2">|</a>				
					<a href="javascript:void(0);" class="lang <?= ($lang == 'en') ? 'red-text' : ''; ?>" data-lang="en">English</a>       	
				</div>
			</div>
	...
	<script>var NoTimeSlot = "<?= $ln['no_time_slot'] ?>";</script>
	<script>var DoctorDetail = "<?= $ln['doctor_detail'] ?>";</script>
